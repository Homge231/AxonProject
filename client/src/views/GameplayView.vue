...
async function fetchQuestion(): Promise<QuestionPayload> {
  try {
    ...
    const mocks: QuestionPayload[] = [
      {
        hint: 'A place where travelers stay overnight',
        question_text: 'After arriving in Da Nang, they checked into their ________.',
        target_word: 'hotel'
      },
      {
        hint: 'A document required for international travel',
        question_text: 'She showed her ________ at the airport security checkpoint.',
        target_word: 'passport'
      },
      {
        hint: 'A relaxing seaside destination',
        question_text: 'Many tourists visit My Khe ________ during summer vacations.',
        target_word: 'beach'
      }
    ]
